    ...
    <div className='w-full h-screen text-center bg-neutral-900 text-white'>
      ...
      <div className='flex flex-col p-4 items-center justify-center w-full h-[95vh]'>
        <h1 className='text-4xl font-bold mb-4'>
          <span className='meetup-text text-5xl'>UniTalk</span> - Connect Instantly
        </h1>
        <p className='text-lg text-neutral-400 mb-6'>
          No sign-ups, no downloads—just smooth, secure video calls with UniTalk. Stay connected with ease.
        </p>
